...
- Term descriptions, data types, and units: NEON.D07.MLBS.DP1.10098.001.variables.20260106T155703Z.csv
...
Issue: Duplicate tagIDs across plots: Quality checks in 2022 and 2023 brought to light hundreds of duplicate occurrences in past data of individualIDs that span multiple plots in the VST mapping and tagging, apparent individuals, and nonwoody tables.
    Date Range: 2014-01-01 to 2024-07-01
    Location(s) Affected: STEI, TREE, UNDE, KONZ, UKFS, SOAP, TEAK, DEJU
Resolution Date: 
Resolution: Domain staff have used old data sheets and field visits to find resolutions for these duplicates. Most of these have been resolved, but a few domains still have pending work, and a few hundred duplicates remain in the data. These are noted with a “multi-plot duplicate” dataQF in the mapping and tagging table, which will be removed pending resolutions.
Issue Date: 2025-02-17
Issue: Missed Xerophyllum sampling: Xerophyllum tenax (XETE) should have been sampled at ABBY_004 in 2019 and was not. Additionally, XETE should have been sampled at WREF_076 and WREF_077 in 2019 and 2021-2023 and was not.
    Date Range: 2019-07-15 to 2024-11-21
    Location(s) Affected: ABBY, WREF
Resolution Date: 2025-12-31
Resolution: From 2025 onward, sampling for Xerophyllum tenax is sampled for all eventTypes at affected locations. Edits were made to the ‘xerophyllumPresent’ field in the vst_perplotperyear table to document plotIDs where Xerophyllum should have been sampled but was not and will be available in provisional data and in RELEASE-2026.
Issue Date: 2025-11-19
Issue: Removing dynamic fields in vst_mappingandtagging: Prior to 2024, the ‘subplotID’ reported for each ‘individualID’ in the vst_mappingandtagging table was static through time, and the ‘nestedSubplotID’ in the same table contained additional nested subplot data where applicable. In addition, the ‘eventID’ in the vst_mappingandtagging table communicated the sampling event in which the individual was first tagged. Beginning in 2024, a new subplotID structure was created that combines the previous subplotID data with both the nestedSubplotID and the nested subplot sampling area. Because nested subplot sampling area may change through time (e.g., due to persistent stem density changes within a plot), the new subplotID is no longer static and is therefore inappropriate for the vst_mappingandtagging table which is focused on data that are static through time (i.e., individualID, taxonID, geolocation data, etc.).
    Date Range: 2013-01-01 to 2025-11-07
    Location(s) Affected: All
Resolution Date: 2025-12-31
Resolution: Beginning with RELEASE-2025, the new ‘subplotID’ is published in the vst_apparentindividual table that captures data for each individualID that are dynamic through time. With RELEASE-2026, the subplotID and nestedSubplotID are no longer published in the vst_mappingandtagging table; moreover, the ‘eventID’ is also no longer published in the vst_mappingandtagging table because a temporal grouping variable is not relevant for the static data published in this table.
Issue Date: 2025-02-17
Issue: Crown diameter error: For leaning individuals, the main bole(s) may extend beyond the average extent of the crown. At affected locations, crown diameter measurements incorrectly included the extending bole(s) rather than capturing diameter data that approximate the area of the crown as seen from above as intended.
    Date Range: 2015-07-01 to 2024-11-21
    Location(s) Affected: RMNP, NIWO, ABBY, WREF
Resolution Date: 2025-02-17
Resolution: From 2025 onward, reported crown diameter data conform to protocol expectations.
Issue Date: 2024-11-08
Issue: Legacy data collection: During the 2015 field season, incomplete data collection occurred at three sites. At the D08 DELA and LENO sites, plots were incorrectly sampled during the summer and then were fully sampled again later in the autumn of 2015 at the correct time of year. At the D03 OSBS site, the plots OSBS_017 and OSBS_021 were sampled in 2015 and data was recorded in the vst_apparentindividual table, but no associated records in the vst_mappingandtagging table were created. In addition, the plots in question at OSBS are no longer prescribed for Vegetation structure sampling and have not been sampled for Vegetation structure since 2015.
    Date Range: 2015-01-01 to 2016-01-01
    Location(s) Affected: OSBS, DELA, LENO
Resolution Date: 2024-12-31
Resolution: Records summer 2015 sampling effort at DELA and LENO have been deleted, and the 2015 vst_apparentindividual records from OSBS that lack vst_mappingandtagging records have also been deleted.  These records will not show up in the 2025 data release and onward.
Issue Date: 2024-09-05
Issue: Yucca sampling: The protocol lacked a height threshold for sampling the yucca growth form, resulting in sampling many small-stature yucca that likely contribute relatively little to plot-level biomass. The protocol also lacked guidance for measuring ‘height’ for yucca with flower stalks. As such, all past 'height' measurements for yucca are unclear with respect to whether the individual was flowering and whether the flower stalk may have been included in the height.
    Date Range: 2014-01-01 to 2024-08-14
    Location(s) Affected: JERC, OSBS, GUAN, CPER, CLBJ, JORN, SRER
Resolution Date: 2024-08-27
Resolution: A 30 cm height threshold for sampling yucca was introduced, identical to the threshold used for sampling ferns. Flower stalks are ignored when measuring height on flowering individuals.
Issue Date: 2025-01-15
Issue: Break height error: Break height data may have been recorded incorrectly for broken boles at D16 sites from the beginning of Operations through the 2023 sampling events. The intent is to report the vertical distance between the ground and the average height of the break above the ground. Instead, technicians may have reported break height data corresponding to the height of the break itself. That is, for a jagged break, the reported data could correspond to vertical distance between the lowest and highest parts of the break.
    Date Range: 2015-07-01 to 2023-12-01
    Location(s) Affected: ABBY, WREF
Resolution Date: 2024-08-01
Resolution: From 2024 onward, reported break height data conform to protocol expectations.
